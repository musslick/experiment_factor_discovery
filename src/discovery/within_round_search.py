...
def _score_precomputed_candidate(
    ...
    This is shared by ordinary synthesized candidates and automatically derived
    level contrasts, ensuring contrasts are judged by the same statistical path
    as their parent factors.
    """
